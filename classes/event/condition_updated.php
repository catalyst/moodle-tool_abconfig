...
class condition_updated extends base {
    ...
    public static function get_name() {
        return get_string('event_condition_updated', 'tool_abconfig');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '{$this->userid}' updated condition set '{$condset}' for experiment '{$eid}'.";
    }
