...
class condition_deleted extends base {
    ...
    public static function get_name() {
        return get_string('event_condition_deleted', 'tool_abconfig');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '{$this->userid}' deleted condition set '{$condset}' for experiment '{$eid}'.";
    }
