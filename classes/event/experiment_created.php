...
/**
 * experiment_created event class.
 *
 * @package   tool_abconfig
 * @copyright Catalyst IT
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class experiment_created extends base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('event_experiment_created', 'tool_abconfig');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '{$this->userid}' created the experiment '{$shortname}'.";
    }
